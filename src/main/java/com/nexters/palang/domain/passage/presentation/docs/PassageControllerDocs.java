...
public interface PassageControllerDocs {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "PASSAGE_400_1: 이미지 파일만 업로드할 수 있습니다."),
            @ApiResponse(responseCode = "422", description = "PASSAGE_422_1: 이미지에서 텍스트를 인식하지 못했습니다."),
            @ApiResponse(responseCode = "503", description = "PASSAGE_503_1: OCR 처리 중 오류가 발생했습니다.")
    })
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "404", description = "BOOK_404_1: 해당 도서를 찾을 수 없습니다.<br>USER_404_1: 해당 사용자를 찾을 수 없습니다.")
    })
